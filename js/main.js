...
$(document).ready(function(){
    VB = {
        ...
        base: {
            ...
            'sobel'                 : function() {return new vb.Block('Sobel', sobel)},
            'invert'                : function() {return new vb.Block('Invert Filter', invert)},
            'binarize'              : function() {return new vb.Block('Binarize Filter', binarize)},
            'colorRearrangement'    : function() {return new vb.Block('Color Rearrangement', colorRearrangement)},
            'grayscale'             : function() {return new vb.Block('Gray Scale', grayscale)},
            'swirl'                 : function() {return new vb.Block('Twirl', swirl)},
            ...
            'blur'                  : function() {return new vb.Block('Blur Filter', bluring)},
